...
def create_logger_name_for_args(args):
    name = ["YNETBaselineSampling"]

    name.append("lr_{}".format(args.lr))
    name.append("bs_{}".format(args.batch_size))
    name.append("e_{}".format(args.max_epochs))
    name.append("h_{}".format(args.height))
    name.append("w_{}".format(args.width))
    name.append("hs_{}".format(args.heatmap_sigma))
    name.append("tl_{}".format(args.traj_lambda))
    name.append("tmp_{}".format(args.temperature))
    name.append("TTST_{}".format(args.use_TTST))
    name.append("rth_{}".format(args.rel_threshold))
    name.append("ng_{}".format(args.num_goals))
    name.append("CWS_{}".format(args.use_CWS))
    name.append("sf_{}".format(args.sigma_factor))
    name.append("nt_{}".format(args.num_traj))
