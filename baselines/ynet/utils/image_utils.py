...
def sampling(probability_map, num_samples, rel_threshold=None, replacement=False):
	# rel_threshold - relative threshold - eg. 2% - so you consider what's bigger thant 2% of max value in heatmap
	...
	# preds: batch, timestep, 2  - where x, y are row/column indices in the original probability map
	return preds
